...
public class AddressToCoordinatesServiceTest {
    ...
    void whenValidLocation_thenReturnCoordinates() throws MalformedURLException, JsonProcessingException, URISyntaxException {
        ...
        URI url = new URI(AddressToCoordinatesService.PS_API_URL + String.format("&query=%s", foz_coa));
        ...
        verify(restTemplate, VerificationModeFactory.times(1)).getForEntity(url, String.class);
